...
A world-class, conversion-focused website for Thrayee Studio, a premium interior design studio based in Hyderabad, India.
...
```bash
git clone https://github.com/thraye/thrayee-studio-website.git
cd thrayee-studio-website
npm install
```
